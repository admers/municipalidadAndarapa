...
$filesA=$classAdmin->datos_Novedadescontrolador($datos[1]);
if($filesA->rowCount()){
    $campos=$filesA->fetch();
    ?>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-10 col-md-offset-1">
                                    <form action="<?php echo SERVERURL; ?>ajax/adminAjax.php" method="POST"  autocomplete="off" data-form="update" class="FormularioAjax" enctype="multipart/form-data">
                                        <input type="hidden" value="<?php echo $campos['id_novedades']; ?>" name="idpdUN">
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group label-floating">
                                                <label class="control-label">Titulo</label>
                                                <input class="form-control" type="text" name="titulopdUN" value="<?php echo $campos['titulo_nove']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12">
                                            ...
                                            <input class="form-control " type="file"  name="archivoUN" required>
                                            <p class="help-block">Formato de documentos admitido PDF y DOC.</p>
                                            <input type="hidden" value="<?php echo $campos['direc_nove']; ?>" name="archivoAntiguoN" >
